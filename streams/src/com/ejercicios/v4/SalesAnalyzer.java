...
//            .forEach(e -> System.out.printf("  %s: $%,.2f%n", e.getKey(), e.getValue()));
        ...
        //EXPLICACION LINEA //.entrySet().stream()
        Set<Map.Entry<String,Double>> entrySet = map.entrySet();
        Stream<Map.Entry<String,Double>> stream2 = entrySet.stream();
        		
        //EXPLICACION LINEA .sorted(Map.Entry.<String, Double>comparingByValue().reversed())
        
        Comparator<Map.Entry<String,Double>> comparator1 = 
        			Map.Entry.<String, Double>comparingByValue();
        
        Comparator<Map.Entry<String,Double>> comparator2 = 
        			comparator1.reversed();
        
        Stream<Map.Entry<String,Double>> stream3 = 
        			stream2.sorted(comparator2);
        
        System.out.println("**********");
//      stream3.forEach(entryset -> System.out.println("Clave"+entryset.getKey()
//        	+ ", Value: "+entryset.getValue()));
        
        stream3.forEach(e -> System.out.printf("  %s: $%,.2f%n", e.getKey(), e.getValue()));
